...
from resources.recommendation import Recommendations, Recommendation, EmployeeRecommendations
...
api.add_resource(EmployeeRecommendations, '/recommendations/employees')
